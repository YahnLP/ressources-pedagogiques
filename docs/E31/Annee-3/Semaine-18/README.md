# S18 – Le Document d'Architecture Technique (DAT) : Structure, Normes, Exemples

| **Champ** | **Détail** |
|-----------|-----------|
| **Semaine** | S18 — Année 3 |
| **Module** | E31 — Réseaux informatiques |
| **Public** | Apprentis BAC PRO CIEL — Année 3 |
...
1. **Cours - Documentation DAT**
2. **Gabarit DAT**
3. **Atelier schémas - évaluation DAT**
4. **Grille qualité portfolio**
5. **Aide-mémoire**
