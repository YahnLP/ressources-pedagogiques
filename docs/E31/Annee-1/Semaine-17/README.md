# S17 – Configuration DHCP + DNS - Projet TECHCORP

| **Champ** | **Détail** |
|-----------|-----------|
| **Semaine** | S17 — Année 1 |
| **Module** | E31 — Réseaux informatiques |
| **Public** | Apprentis BAC PRO CIEL — Année 1 |
...
1. **Guide technique — DHCP / DNS**
2. **Guide technique — Tests réseau**
3. **Guide technique — Validation Wireshark**
